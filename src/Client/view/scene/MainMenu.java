...
public class MainMenu extends javax.swing.JFrame {
    ...
    private void btnCreateRoomActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateRoomActionPerformed
        ...
        RunClient.openScene(RunClient.SceneName.CREATEROOM);
    }//GEN-LAST:event_btnCreateRoomActionPerformed

    private void btnJoinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJoinActionPerformed
        // TODO add your handling code here:
//        System.out.println(tbListRoom.getValueAt(tbListRoom.getSelectedRow(), 0));
        RunClient.socketHandler.joinRoomAction(tbListRoom.getValueAt(tbListRoom.getSelectedRow(), 0).toString());
